...
import { Settings2, User, Bell, Shield, Users, Save, Check, Building2, Upload, MapPin, Phone, Globe, Mail, X, Eye, MoreHorizontal, UserCheck, UserX, Edit, Loader2, ShieldCheck, Key, Palette, CalendarCheck, FileText, Wallet } from "lucide-react";
...
import { RepasseSettings } from "@/components/settings/RepasseSettings";
    ...
    <div className="space-y-4 md:space-y-6 animate-fade-in p-2 md:p-0">
      ...
      <Tabs defaultValue="profile" className="space-y-4 md:space-y-6">
        <TabsList className="flex flex-wrap w-full h-auto gap-1 p-1">
          ...
          {hasPermission('settings', 'view', 'repasse') && (
            <TabsTrigger value="repasse" className="flex items-center gap-1 md:gap-2 text-xs md:text-sm py-2">
              <Wallet className="w-3 h-3 md:w-4 md:h-4" />
              <span className="hidden sm:inline">Repasse</span>
