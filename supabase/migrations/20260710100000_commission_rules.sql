...
CREATE INDEX IF NOT EXISTS idx_commission_rules_enabled ON public.commission_rules (enabled);
CREATE INDEX IF NOT EXISTS idx_commission_rules_target_type ON public.commission_rules (target_type);
...
DROP POLICY IF EXISTS "Admins and managers can manage commission_rules" ON public.commission_rules;
