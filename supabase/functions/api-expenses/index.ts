    ...
    switch (req.method) {
      case "GET": {
        if (id) {
          ...
          if (error) {
            ...
            return errorResponse("Erro ao buscar despesa", 500);
          }
          if (!data) return errorResponse("Despesa não encontrada", 404);
        ...
        if (error) {
          ...
          return errorResponse("Erro ao listar despesas", 500);
        }
      ...
      case "POST": {
        ...
        if (error) {
          ...
          return jsonResponse(
            { error: "Erro ao criar despesa", details: error.message, code: error.code },
            500
          );
        }
      ...
      case "PATCH": {
        ...
        if (error) {
          ...
          return jsonResponse(
            { error: "Erro ao atualizar despesa", details: error.message, code: error.code },
            500
          );
        }
        if (!data) return errorResponse("Despesa não encontrada", 404);
      ...
      case "DELETE": {
        ...
        if (error) {
          ...
          return jsonResponse(
            { error: "Erro ao excluir despesa", details: error.message, code: error.code },
            500
          );
        }
        if (!deleted || deleted.length === 0) return errorResponse("Despesa não encontrada", 404);
        return jsonResponse({ message: "Despesa excluída com sucesso" }, 200);
      }
